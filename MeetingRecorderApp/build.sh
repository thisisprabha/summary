...
<dict>
    ...
    <string>This app needs microphone access to record audio for meeting transcriptions and summaries.</string>
    <key>NSCameraUsageDescription</key>
    <string>This app does not use camera, but may request permission as part of media access.</string>
